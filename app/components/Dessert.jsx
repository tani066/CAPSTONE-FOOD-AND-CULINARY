...
; // Replace with your key
  ...
  useEffect(() => {
    const fetchDesserts = async () => {
      const url = `https://api.spoonacular.com/recipes/complexSearch?apiKey=${apiKey}&number=100&type=dessert&addRecipeInformation=true`;
      ...
      try {
        ...
        console.error('Failed to fetch dessert recipes:', err);
    ...
    <div className="p-4 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-3 text-orange-600 font-serif">🍰 Sweet Cravings</h2>
          <p className="text-gray-600 text-lg italic mb-8">Indulge in heavenly dessert delights</p>
          <div className="relative max-w-xl mx-auto">
            <input
              ...
              className="w-full text-gray-600 px-6 py-4 text-lg rounded-full border-2 border-orange-200 focus:border-orange-500 focus:outline-none shadow-md pl-14"
            />
